# Creates the "EAP Monitor Server" desktop shortcut on this machine.
#
...
$lnk     = Join-Path $desktop 'EAP Monitor Server.lnk'

$ws = New-Object -ComObject WScript.Shell
$sc = $ws.CreateShortcut($lnk)
$sc.TargetPath       = $bat
$sc.WorkingDirectory = $backend
$sc.Description      = 'Start EAP Monitor and open the dashboard'
$sc.WindowStyle      = 1
